---
title: "Spectre virtual species: Version B"
author: "Jan Salecker"
date: "8/31/2020"
...
## Spectre virtual species: Version B
...
if (exec == "HPC") {
  ...
  results[[1]] <- get_slurm_out(slr_job = sjob, outtype = "table")
...
#### STORE RESULTS:
saveRDS(results, file=file.path(dir.cloud, "data", "virtualspecies_04_complete_versionB.rds"))
...
```{r calc.min.error, include=FALSE}
...
ggsave(filename="summary_maintext.png", path=plotdir, width=6, height=3, dpi=300)
