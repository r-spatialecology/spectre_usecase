...
ggplot(results_rce, aes(x=factor(corr_within), y=factor(corr_among), fill=rce)) +
  ...
  ggthemes::scale_fill_continuous_tableau(palette="Red-Gold") +
  ggthemes::theme_tufte(base_size = 12)
ggsave("../figures/virtualspecies_03_manuscript_03_rce.png", width=6, height=6, dpi=300)
...
ggplot(results_rce, aes(x=factor(corr_within), y=factor(corr_among), fill=mae)) +
  ...
  ggthemes::scale_fill_continuous_tableau(palette="Red-Gold") +
  ggthemes::theme_tufte(base_size = 12)
ggsave("../figures/virtualspecies_03_manuscript_04_mae.png", width=6, height=6, dpi=300)
...
ggsave("../figures/virtualspecies_03_manuscript_05_maintext.png", width=6, height=3, dpi=300)
