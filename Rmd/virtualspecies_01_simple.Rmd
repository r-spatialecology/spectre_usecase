...
calculate_rec(target, res_min_conf$optimized_grid)
...
## Plot:
plot_virtualspecies(spp.spectre, type="incidence")
plot_virtualspecies(spp.spectre, type="richness")

## Side by side comparison:
plot_virtualspecies(species.stack=list("original" = spp, "spectre" = spp.spectre), type="richness")
