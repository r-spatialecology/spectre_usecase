...
set.seed(3562347)
exec <- "HPC" # "HPC"
dir.hpc <- file.path("/usr/users/shanss/spectre_miss")
dir.cloud <- file.path("/usr/users/shanss/spectre_miss")
...
set.seed(3562347)
exec <- "HPC" # "HPC"
dir.hpc <- file.path("/usr/users/shanss/spectre")
dir.cloud <- file.path("/usr/users/shanss/spectre/results")
...
## Variable parameters:
landscape2_size <- c(10,50,75)
corr2_within <- 0.5
corr2_among <- 0.1
gamma2 <- c(100,250,400)
random2_seeds <- round(runif(replicates) * 100000)

## Generate parameter matrix:
parameters <- expand.grid(landscape_size = landscape2_size, 
                          corr_within = corr2_within,
                          gamma = gamma2, 
                          beta = beta2,
                          corr_among = corr2_among,
                          random_seeds = random2_seeds)
