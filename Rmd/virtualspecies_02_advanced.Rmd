...
plotdir <- "../figures/virtualspecies_advanced"
...
ggsave(filename="virtualspecies_02_advanced_01.png", path=plotdir, width=6, height=6, dpi=300)
...
ggplot(energy_min, aes(x=factor(corr_within), y=factor(corr_among), fill=energy)) +
  ...
  ggthemes::theme_tufte(base_size = 12)
ggsave(filename="virtualspecies_02_advanced_02.png", path=plotdir, width=6, height=6, dpi=300)
...
ggplot(energy_im, aes(x=factor(corr_within), y=factor(corr_among), fill=improvement)) +
  ...
  ggthemes::scale_fill_continuous_tableau(palette="Red-Gold") +
  ggthemes::theme_tufte(base_size = 12)
ggsave(filename="virtualspecies_02_advanced_03.png", path=plotdir, width=6, height=6, dpi=300)
...
ggplot(results_rec, aes(x=factor(corr_within), y=factor(corr_among), fill=rec)) +
  ...
  ggthemes::scale_fill_continuous_tableau(palette="Red-Gold") +
  ggthemes::theme_tufte(base_size = 12)
ggsave(filename="virtualspecies_02_advanced_04.png", path=plotdir, width=6, height=6, dpi=300)
