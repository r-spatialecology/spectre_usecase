...
ggsave("../figures/virtualspecies_03_manuscript_01_min_energy.png", width=6, height=6, dpi=300)
...
ggplot(results_rec, aes(x=factor(corr_within), y=factor(corr_among), fill=rec)) +
  ...
  ggthemes::scale_fill_continuous_tableau(palette="Red-Gold") +
  ggthemes::theme_tufte(base_size = 12)
ggsave("../figures/virtualspecies_02_advanced_02_rec.png", width=6, height=6, dpi=300)
