...
plotdir <- "../figures/virtualspecies_manuscript"
...
ggplot2::ggplot(., ggplot2::aes(x=x, y=y, fill=alpha)) +
  facet_grid(random_seeds+gamma~corr_within+corr_among) +
        ...
        ggplot2::theme_void()  
ggsave(filename=paste0("virtualspecies_03_manuscript_01_sr_", strsplit(i, " ")[[1]][1], ".png"), path=plotdir, width=10, height=10, dpi=300)
}
```
...
ggsave(filename="virtualspecies_03_manuscript_02_min_energy.png", path=plotdir, width=6, height=6, dpi=300)
```
...
ggplot(results_rce, aes(x=factor(corr_within), y=factor(corr_among), fill=rce)) +
  ...
  ggthemes::scale_fill_continuous_tableau(palette="Red-Gold") +
  ggthemes::theme_tufte(base_size = 12)
ggsave(filename="virtualspecies_03_manuscript_03_rce.png", path=plotdir, width=6, height=6, dpi=300)
...
ggplot(results_rce, aes(x=factor(corr_within), y=factor(corr_among), fill=mae)) +
  ...
  ggthemes::scale_fill_continuous_tableau(palette="Red-Gold") +
  ggthemes::theme_tufte(base_size = 12)
ggsave(filename="virtualspecies_03_manuscript_04_mae.png", path=plotdir, width=6, height=6, dpi=300)
...
ggplot(results_rce, aes(x=factor(corr_within), y=factor(corr_among), fill=mc)) +
  ...
  ggthemes::theme_tufte(base_size = 12)
ggsave(filename="virtualspecies_03_manuscript_05_mc.png", path=plotdir, width=6, height=6, dpi=300)
...
ggsave(filename="virtualspecies_03_manuscript_06_maintext.png", path=plotdir, width=6, height=3, dpi=300)
